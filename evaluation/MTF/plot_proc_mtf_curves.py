...
idx = 0
df = pd.read_csv(patient_dirs[idx] / 'I0_3000000_processed' / 'cnn_hd_fbp_sharp_v001_mtf.csv')
df
# %%
def plot_patient_diameter_mtf(patient_diameter_dir, ax=None):
    ...
    df = pd.read_csv(patient_diameter_dir / 'I0_3000000_processed' / 'cnn_hd_fbp_sharp_v001_mtf.csv')
