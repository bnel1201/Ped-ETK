...
clear all;
%Load slice in
folder_path = '/gpfs_projects/rxz4/data/DLCT/phantom_realscan/NIH_Catphan600_Mar2020/3941_high/3946/'; 
%folder_path = '/gpfs_projects/rxz4/data/DLCT/phantom_realscan/NIH_Catphan600_Mar2020/redcnn_processed/3941_high/smoothM1-R0-S3/3946/'; 
...
if(find_disk_loc==1)
    ...
    %locs=[338 253; 328 294; 261 333; 191 294];  %B30f-3mm-380mm-FBP the four negative HU objects Air PMP LDPE Polysterene  
    locs=[387 250; 370 313; 262 376; 153 313];  %B30f-3mm-240mm-FBP 
end
 n_locs = size(locs,1);    
