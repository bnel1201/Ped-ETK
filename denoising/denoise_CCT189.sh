...
do
   for DOSELEVEL in 0090000 0165000 0210000 0255000 0300000
   do
      echo $DIAMETER $DOSELEVEL
      for OBJ in disk bkg
      do
      INPUT_FOLDER="${BASE_DIR}"/$PHANTOM/monochromatic/diameter"${DIAMETER}"mm/I0_"${DOSELEVEL}"/$OBJ/
      OUTPUT_FOLDER="${BASE_DIR}"/$PHANTOM/monochromatic/diameter"${DIAMETER}"mm/I0_"${DOSELEVEL}"_processed/$OBJ/
